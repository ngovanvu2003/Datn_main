...
const MenuCombo = () => {
  return (
    <div>
        <section id="menu-3" className="wide-100 menu-section division">
            <div className="container">
                 ...
                 <div className="menu-3-wrapper">
                     <div className="row">
                         <div className="col-md-12">
                             <div className="menu-3-title"><h3 className="h3-md red-color">Drinks & Sweets</h3></div>
                         </div>
                     </div>
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="menu-3-txt">
                                <ul className="menu-3-list">
                                    <li className="menu-3-item">
                                        <a href="product-single.html">
                                            <div className="menu-title-wrapper rel">
                                                <div className="menu-item-title"><h5 className="h5-sm">Blueberry Smoothie</h5></div>
                                                <div className="menu-item-dots"></div>
                                                <div className="menu-item-price"><h5 className="h5-sm">$2.99</h5></div>
                                                <div className="menu-3-item-data bg-grey"><h6 className="h6-xs">0.375L</h6></div>
                                            </div>
                                            <div className="menu-item-desc">
                                                <p>Integer ultrice an aligula lectus purus and tempor</p>
                                            </div>
                                        </a>
                                    </li>
                                    <li className="menu-3-item">
                                        <a href="product-single.html">
                                            <div className="menu-title-wrapper rel">
                                                <div className="menu-item-title"><h5 className="h5-sm">Ice Lime Cola</h5></div>
                                                <div className="menu-item-dots"></div>
                                                <div className="menu-item-price"><h5 className="h5-sm">$1.95</h5></div>
                                                <div className="menu-3-item-data bg-grey"><h6 className="h6-xs">0.5L</h6></div>
                                            </div>
                                            <div className="menu-item-desc">
                                                <p>Integer ultrice an aligula lectus purus and tempor</p>
                                            </div>
                                    ...
                                    <li className="menu-3-item">
                                        <a href="product-single.html">
                                            <div className="menu-title-wrapper rel">
                                                <div className="menu-item-title"><h5 className="h5-sm">Soda Bottles</h5></div>
                                                <div className="menu-item-dots"></div>
                                                <div className="menu-item-price"><h5 className="h5-sm">$5.95</h5></div>
                                                <div className="menu-3-item-data bg-grey"><h6 className="h6-xs">0.5L</h6></div>
                                            </div>
                                    ...
                                    <li className="menu-3-item resp-lst">
                                        <a href="product-single.html">
                                            <div className="menu-title-wrapper rel">
                                                <div className="menu-item-title"><h5 className="h5-sm">Black Coffee</h5></div>
                                                <div className="menu-item-dots"></div>
                                                <div className="menu-item-price"><h5 className="h5-sm">$3.15</h5></div>
                                                <div className="menu-3-item-data bg-grey"><h6 className="h6-xs">0.150L</h6></div>
                                            </div>
                                            <div className="menu-item-desc">
                                                <p>Integer ultrice an aligula lectus purus and tempor</p>
                                            </div>
                            ...
                            <div className="menu-3-txt">
                                <ul className="menu-3-list">
                                    <li className="menu-3-item">
                                        <a href="product-single.html">
                                            <div className="menu-title-wrapper rel">
                                                <div className="menu-item-title"><h5 className="h5-sm">Cheesecake</h5></div>
                                                <div className="menu-item-dots"></div>
                                                <div className="menu-item-price"><h5 className="h5-sm">$4.05</h5></div>
                                                <div className="menu-3-item-data bg-grey"><h6 className="h6-xs">305g</h6></div>
                                            </div>
                                            <div className="menu-item-desc">
                                                <p>Integer ultrice an aligula lectus purus and tempor</p>
                                            </div>
                                    ...
                                    <li className="menu-3-item">
                                        <a href="product-single.html">
                                            <div className="menu-title-wrapper rel">
                                                <div className="menu-item-title"><h5 className="h5-sm">Chocolate Cake</h5></div>
                                                <div className="menu-item-dots"></div>
                                                <div className="menu-item-price"><h5 className="h5-sm">$4.25</h5></div>
                                                <div className="menu-3-item-data bg-grey"><h6 className="h6-xs">285g</h6></div>
                                            </div>
                                            <div className="menu-item-desc">
                                                <p>Integer ultrice an aligula lectus purus and tempor</p>
                                            </div>
                                    ...
                                    <li className="menu-3-item">
                                        <a href="product-single.html">
                                            <div className="menu-title-wrapper rel">
                                                <div className="menu-item-title"><h5 className="h5-sm">Belgian Waffle</h5></div>
                                                <div className="menu-item-dots"></div>
                                                <div className="menu-item-price"><h5 className="h5-sm">$7.95</h5></div>
                                                <div className="menu-3-item-data bg-grey"><h6 className="h6-xs">275g</h6></div>
                                            </div>
                                            <div className="menu-item-desc">
                                                <p>Integer ultrice an aligula lectus purus and tempor</p>
                                            </div>
                                    ...
                                    <li className="menu-3-item">
                                        <a href="product-single.html">
                                            <div className="menu-title-wrapper rel">
                                                <div className="menu-item-title"><h5 className="h5-sm">Strawberry Ice Cream</h5></div>
                                                <div className="menu-item-dots"></div>
                                                <div className="menu-item-price"><h5 className="h5-sm">$3.85</h5></div>
                                                <div className="menu-3-item-data bg-grey"><h6 className="h6-xs">230g</h6></div>
                                            </div>
                                            <div className="menu-item-desc">
                                                <p>Integer ultrice an aligula lectus purus and tempor</p>
                                            </div>
