          ...
          <div className="row">
            <div className="col-lg-10 offset-lg-1">
              <div className="section-title text-center">
                <h2 className="h2-xl red-color font-normal">
                  KHUYẾN MẠI HOT NHẤT
                </h2>
                <p className="p-xl">
                        ...
                        <a href="menu-3.html">
                          <div className="pbox-4">
                            <div className="hover-overlay">
                              <img
                                className="img-fluid"
                                src="/ImagesCLient/poster1 (2).jpg"
                                alt="promo-image"
                              />
                            </div>
                          </div>
                ...
                <a href="/Order">
                  <button
                    id="order"
                    type="submit"
                    className="bg-[#E3000E] text-white font-bold"
                    style={{ padding: "15px 55px" }}
                  >
                    ĐẶT BÀN NGAY
                  </button>
                </a>
