						...
						<div className="row">
							...
							<div className="col-sm-6 col-lg-3">
								<div className="footer-contacts mb-30">
									...
									<p className="mt-5"><span className="yellow-color"><a href="tel:123456789">789-654-3210</a></span></p>
								</div>	
							</div>
							<div className="col-sm-6 col-lg-3">
							...
							<div className="row d-flex align-items-center">
								<div className="col-lg-10 offset-lg-1">
									<ul className="bottom-footer-list clearfix">
										...
										<li><p className="first-li"><a href="#">About Us</a></p></li>
										<li><p><a href="#">Gift Cards</a></p></li>
										<li><p><a href="#">Terms Of Use</a></p></li>	
										<li><p className="last-li"><a href="#">Privacy Policy</a></p></li>
									</ul>
								</div>
							</div>
						</div>
