          ...
          <div className="row">
            <div className="col-md-6 col-lg-3">
              <div className="cbox-3 text-center">
                <div style={{ borderRadius: "5px" }} className="hover-overlay">
                  <img
                    style={{
                      height: "500px",
                      borderRadius: "5px",
              ...
              <div className="cbox-3 text-center">
                ...
                <div className="cbox-3-txt">
                  ...
                  <h6 className="h6-xl">
                    Phone:{" "}
                    <span>
                      <a href="tel:123456789">789-456-0123</a>
                    </span>
                  </h6>
                  <h6 className="h6-lg">Address</h6>
              ...
              <div className="cbox-3 text-center">
                ...
                <div className="cbox-3-txt">
                  ...
                  <h6 className="h6-xl">
                    Phone:{" "}
                    <span>
                      <a href="tel:123456789">789-645-0123</a>
                    </span>
                  </h6>
                  <h6 className="h6-lg">Address</h6>
