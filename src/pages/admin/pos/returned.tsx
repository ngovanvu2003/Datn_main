...
const AdminPosReturned = () => {
  ...
  const { data: orderPosDetailApi, isLoading: isLoadingOrderPosDetail } =
    useGetOrderDetailsOptionQuery("?orderable_status=-1&orderBy=updated_at");
                        ...
                        return (
                          <tr key={index} className="status-done className-all">
                            ...
                            <td className="text-capitalize">
                              {orderDetail.orderable_status == "-1" && (
                                <span className="badge-soft-warning px-2 py-1 rounded">
                                  Đã trả đồ
                                </span>
                              )}
                            </td>
...
export default AdminPosReturned;
