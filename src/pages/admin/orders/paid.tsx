...
const AdminOrderPaid = () => {
  ...
  const orderPaid = ordersData?.data?.data.filter(
        ...
        <div className="py-4">
          <div className="table-responsive datatable-custom">
            <table className="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
              ...
              <tbody id="set-rows">
                {orderPaid?.map((order: IOrder, index: any) => {
                  return (
                    <tr className="status-done className-all" key={index}>
                      <td>
                        <div>
          ...
          <div className="d-flex justify-content-lg-end">
            <nav>
              <ul className="pagination">
                {ordersData?.data?.links?.map((link: any, index: number) => (
                  <li
                    key={index}
                    className={`page-item 
